/** avatar component - Render avatar image in case it is provided, otherwise, display initials
 * 
 * @param {*} _avatar 
 * @param {*} _name 
 * @param {*} _color 
...
/** progressBar - Render user and progress bar from its stats
 * 
 * @param {*} _active 
 * @param {*} _completed 
 * @param {*} _total 
